package com.challengespring.crashbandicoot.utils;

import com.challengespring.crashbandicoot.entities.User;
import com.challengespring.crashbandicoot.repositories.UserDao;
...
public class Outputter implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = new User("CoCo", "Bandicoot", 22);
        LOG.info("******************");
        ...
        User user2 = new User("Crash", "Bandicoot", 33);
        LOG.info("******************");
        LOG.info(user2 + " has been created !");
        userDao.save(user2);
        LOG.info(user2 + " has been saved !");

        User user3 = new User("uka", "uka", 500);
        LOG.info("******************");
        ...
        User updateUser = userDao.findById(3L).get();
        updateUser.setAge(600);
